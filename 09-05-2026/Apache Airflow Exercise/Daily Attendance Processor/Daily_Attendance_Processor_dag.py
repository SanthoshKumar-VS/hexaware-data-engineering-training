...
def calculate_attendance_percentage():
    ...
    print("Attendance Percentage =", str(int(percentage)) + "%")
...
def generate_attendance_report():
    ...
    with open("/tmp/attendance_report.txt", "w") as file:
        ...
        file.write("Present Students = 7\n")
        file.write("Absent Students = 3\n")
        file.write("Attendance Percentage = 70%\n")
        file.write("Status = " + status_message + "\n")
